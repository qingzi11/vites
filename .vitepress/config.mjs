...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '前端', items:[
        {text: 'HTML',link:'/html笔记'},
        {text: 'CSS',link:'/CSS'},
        {text: 'JS',link:'/js'},
        {text: 'Jqury',link:'/jq'},
        {text: 'ajax',link:'/ajax'},
        {text: 'Vitepress',link:'/vite'},
      ]},
      { text: 'C语言',link: '/c'},
      { text: '家', link: '/' },
    ],
